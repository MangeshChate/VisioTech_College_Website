        ...
        <div className='pb-5 bg-body-secondary  d-flex flex-column justify-content-center pt-5 align-items-center '>
            ...
            <div className='grid lg:grid-cols-2 grid-cols-1 gap-3 lg:gap-[100px]'>
                <div className='w-full flex flex-col gap-5 justify-center items-center '>
                    ...
                    <a href='https://docs.google.com/forms/d/e/1FAIpQLSdnfS-hmnPpFpxabZ6T0Qgeb2BQRwkc317dBZzXRPZB4F1sVg/viewform' target="_blank" className='text-blue-700 text-lg'>
                ...
                <div className='w-full flex flex-col gap-2 lg:gap-5 justify-center '>
                    <div className='flex text-center lg:text-start flex-col lg:p-0 p-3'>
                        <span className='text-xl lg:text-3xl font-bold mb-3'>PROJECT COMPETITION PRIZE</span>
                        <span className=' lg:text-2xl'>1st Price : 10,000 /-</span>
                        <span className='lg:text-2xl'>2nd Price : 5,000 /-</span>

                    </div>
                    <div className='flex text-center lg:text-start flex-col lg:p-0 p-3'>
                        <span className='text-xl lg:text-3xl font-bold lg:mb-3'>ALL EVENTS PRIZE </span>
                        <span className='lg:text-2xl'>1st Price : 2100/-</span>
                        <span className='lg:text-2xl'>2nd Price : 1100/-</span>
