...
const aboutData = [
  {
    ...
    paragraph:`
    It is immense pleasure to write for VSIOTECH-2024, a technical event organized by the students of MGM’s college of Engineering, Nanded. This has become a regular feature of this campus with encouraging participation of students from all other engineering college.
  ...
  },
  {
    ...
    paragraph:`Since 1984 MGM’s College of Engineering is functioning in this region maintaining a steady progress. With the UG, PG courses in five faculties of engineering, the research centers in mechanical and computer engineering also made their mark along the way. We take pride in our pass outs working in organizations of repute all over the world. While educating today’s engineers along with the knowledge of different subjects, including the appropriate skill-sets has become essential. To think creatively, to work on ideas, to communicate well, to work in a team are the inevitable parts of education if it is to be there for ‘value addition’ in true sense. To enhance the capabilities you have to go on challenging yourself and the opportunity of having such a challenges is provided through the activities like “Visiotech”. This year it has been planned on 27th & 28th March 2024. This year along with popular events like Blind C, Code IT, Troubleshoot IT, Dominators League in Computer Science and Engineering; Bug Munch, Query Mania, Web Magic, Python Striker in Information Technology; Minute to Win It, Circuit Designing, Circuit Debugging, Cryptic Crossword Puzzle in Electronics and Telecommunication Engineering; CAD War, Bridge IT, Traversing, Lab Expert in Civil Engineering; CNC Programming, Drone Technology, CAD War, Robotic in Mechanical Engineering some interdisciplinary events like Project Competition, Click the Best, Picasso, Poster Presentation, Paper Presentation has been organized. I welcome the students with creative talents to come forward and be a part of humming enthusiasm of MGM students in our campus. Challenge yourself and be the winners. Share the ideas and learn from each other. Come together and contribute for the development of engineering education. I look forward to see you all here.`
  }
]
