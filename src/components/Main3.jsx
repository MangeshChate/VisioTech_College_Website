            ...
            <div className="container-fluid bg-dark position-absolute text-light d-flex justify-content-center align-items-center h-100 w-100 bg-opacity-75 ">
                <div className=' container '>
                    ...
                    <div className=" flex flex-col   justify-center">
                        ...
                        <h1 className='fw-bold text-2xl lg:text-4xl  mb-4'>MGMs College Of Engineering Nanded</h1>
                        <p className='text-lg lg:text-2xl '>  To ensure sustainable human development which encourages self reliant and self content society and to promote activities related to community services and social welfare..
                    ...
                    <div className="hidden lg:flex justify-center">
                        ...
                        <img src="https://images.collegedunia.com/public/college_data/images/campusimage/141983345422220124301934934.jpg" alt="" className='shadow-lg  rounded-4 w-[700px] h-[400px]' />
